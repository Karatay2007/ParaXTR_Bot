#!/usr/bin/env python3
"""Arven Solé — Nefesim Daralıyor YouTube Short (latest Short language)."""
...
OUT_SHORT = Path("/workspace/ArvenSole_NefesimDaraliyor_SHORT.mp4")
...
# Hottest chorus 2 — title hook Nefesim daralıyor (no DEVAMI YAYINDA)
SHORT_T0 = 114.5
SHORT_T1 = 149.5
WORD_LEAD = 0.05

LINES: list[list[tuple[float, float, str]]] = [
    [(114.82, 115.94, "Nefesim"), (115.94, 117.32, "daralıyor")],
    [(118.18, 118.70, "içim"), (118.70, 119.96, "sızlıyor")],
    [(119.96, 121.46, "Tutamam"), (121.46, 122.40, "artık"), (122.40, 123.46, "şimdi"), (123.46, 125.04, "kopuyor")],
    [(128.10, 129.50, "Geçemedim"), (129.50, 130.82, "senden")],
    [(130.82, 132.26, "geçemedim"), (132.26, 133.04, "yine")],
    [(133.04, 134.08, "Ne"), (134.08, 134.54, "kadar"), (134.54, 135.20, "uzak"), (135.20, 136.00, "olsam")],
    [(136.00, 136.56, "sen"), (136.56, 137.56, "kaldın"), (137.56, 138.62, "içimde")],
    [(138.62, 140.16, "Geçemedim"), (140.16, 141.36, "senden")],
    [(141.42, 142.90, "geçemedim"), (142.90, 143.72, "yine")],
    [(143.72, 145.22, "Söyleme"), (145.22, 145.74, "bitti"), (145.74, 146.42, "diye"), (146.42, 146.88, "ben"), (146.88, 148.26, "bitmedim"), (148.26, 149.26, "seni")],
]
...
def render_short() -> None:
    ...
    audio_clip = Path("/tmp/nefesim_short_clip.wav")
    subprocess.check_call(
        [
            "ffmpeg", "-y",
