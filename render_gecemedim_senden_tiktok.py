#!/usr/bin/env python3
"""Arven Solé — Geçemedim Senden TikTok (latest Short language)."""
...
OUT_TIKTOK = Path("/workspace/ArvenSole_GecemedimSenden_TIKTOK.mp4")
...
def render_tiktok() -> None:
    ...
    audio_clip = Path("/tmp/gecemedim_short_clip.wav")
    subprocess.check_call(
        [
            "ffmpeg", "-y",
