#!/usr/bin/env python3
"""Arven Solé — Unutamadım Seni YouTube Short (latest Short language)."""
...
OUT_SHORT = Path("/workspace/ArvenSole_UnutamadimSeni_SHORT.mp4")
...
# Hottest chorus 2 — title hook Unutamadım seni (no DEVAMI YAYINDA)
SHORT_T0 = 126.9
SHORT_T1 = 157.0
WORD_LEAD = 0.05
...
def render_short() -> None:
    ...
    audio_clip = Path("/tmp/unutamadim_short_clip.wav")
    subprocess.check_call(
        [
            "ffmpeg", "-y",
