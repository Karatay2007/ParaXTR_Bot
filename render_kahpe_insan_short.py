#!/usr/bin/env python3
"""Arven Solé — Kahpe İnsan YouTube Short (latest Short language, no DEVAMI)."""
...
OUT_SHORT = Path("/workspace/ArvenSole_KahpeInsan_SHORT.mp4")
...
def render_short() -> None:
    ...
    audio_clip = Path("/tmp/kahpe_short_clip.wav")
    subprocess.check_call(
        [
            "ffmpeg", "-y",
