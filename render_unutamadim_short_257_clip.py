#!/usr/bin/env python3
"""Unutamadım Seni — TikTok Short from 2:57, real couple footage + elegant quote. No lyric UI."""
...
OUT = Path("/workspace/ArvenSole_UnutamadimSeni_TIKTOK_SHORT_257.mp4")
ART = Path("/opt/cursor/artifacts")
STOCK = Path("/tmp/unut_couple")
WORK = Path("/tmp/unut_short257")
...
# Real video beds: two people — distance / can't reunite (not stills)
SEGMENTS = [
    (STOCK / "4714.mp4", 0.0, 10.0),    # woman looking away, man blurred behind
    (STOCK / "4574.mp4", 0.5, 14.0),    # couple back-to-back on sofa
    (STOCK / "18308.mp4", 3.0, 16.0),   # heart drawn on rainy foggy window
]
